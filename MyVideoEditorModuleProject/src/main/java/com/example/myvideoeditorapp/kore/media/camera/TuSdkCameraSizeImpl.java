...
public class TuSdkCameraSizeImpl implements TuSdkCameraSize
{
    ...
    public void configure(final TuSdkCameraBuilder h) {
        ...
        CameraHelper.setPictureSize(TuSdkContext.context(), b, TuSdkSize.create(b.getPreviewSize().width, b.getPreviewSize().height).limitSize(), this.getOutputPictureRatio());
        this.a(b);
