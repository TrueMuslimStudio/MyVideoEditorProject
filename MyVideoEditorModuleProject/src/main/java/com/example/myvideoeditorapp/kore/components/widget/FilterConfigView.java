...
package com.example.myvideoeditorapp.kore.components.widget;
...
public class FilterConfigView extends TuSdkRelativeLayout
{
    ...
    public View getResetButton() {
        if (this.b == null) {
            ...
            if (this.b != null) {
                this.b.setOnClickListener((OnClickListener)this.mOnClickListener);
            }
        }
        return this.b;
    }
    ...
    public View getStateButton() {
        if (this.c == null) {
            ...
            if (this.c != null) {
                this.c.setOnClickListener((OnClickListener)this.mOnClickListener);
            }
        }
        return this.c;
    }
    ...
    protected void handleShowStateAction() {
        ...
        this.j = true;
        final boolean b = this.getConfigWrap().getVisibility() == View.VISIBLE;
