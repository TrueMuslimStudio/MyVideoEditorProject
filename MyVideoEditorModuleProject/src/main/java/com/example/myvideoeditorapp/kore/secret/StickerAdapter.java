...
import com.example.myvideoeditorapp.kore.task.ImageViewTask;
...
public class StickerAdapter extends TuSdkDownloadAdapter<ImageViewTaskWare>
{
    ...
    public void loadThumb(StickerData var1, ImageView var2) {
        if (var1 != null && var2 != null) {
            StickerData var3 = (StickerData)this.d.get(var1.stickerId);
            if (var3 != null) {
                StickerThumbTaskImageWare var4 = new StickerThumbTaskImageWare(var2, var3);
                this.loadImage(var4);
            }
        }
    }
    public void loadGroupThumb(StickerGroup var1, ImageView var2) {
        if (var1 != null && var2 != null) {
            StickerGroup var3 = (StickerGroup)this.b.get(var1.groupId);
            if (var3 != null) {
                StickerGroupThumbTaskImageWare var4 = new StickerGroupThumbTaskImageWare(var2, var3);
                this.loadImage(var4);
            }
        }
    }
