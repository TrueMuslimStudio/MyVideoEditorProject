...
import com.example.myvideoeditorapp.kore.type.ResourceType;
import android.widget.Toast;
import com.example.myvideoeditorapp.kore.utils.ReflectUtils;
import com.example.myvideoeditorapp.kore.utils.hardware.TuSdkSharedPreferences;
...
public class TuSdkContext
{
    ...
    public void toast(final String s) {
        Toast.makeText(this.b, (CharSequence)s, 0).show();
    }
