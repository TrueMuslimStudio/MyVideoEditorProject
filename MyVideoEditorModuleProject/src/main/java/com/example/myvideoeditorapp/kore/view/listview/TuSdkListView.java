...
public class TuSdkListView extends TuSdkRefreshListView implements TuSdkListViewFlingAction.TuSdkListViewFlingActionDelegate
{
    ...
    public void setItemClickListener(final TuSdkListViewItemClickListener e) {
        this.e = e;
        if (this.e == null) {
            this.setOnItemClickListener((OnItemClickListener)null);
        }
        else {
    ...
    protected OnItemClickListener buildOnItemClickListener() {
        return (OnItemClickListener)new TuSdkOnItemClickListener();
    }
    ...
    protected class TuSdkOnItemClickListener implements OnItemClickListener
    {
