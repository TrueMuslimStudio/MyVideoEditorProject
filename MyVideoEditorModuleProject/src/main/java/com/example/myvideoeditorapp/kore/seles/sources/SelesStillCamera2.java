...
public abstract class SelesStillCamera2 extends SelesVideoCamera2 implements SelesStillCameraInterface
{
    ...
    private boolean r;
    private TuSdkAutoFocusCallback s;
    ...
    protected ImageReader buildJpegImageReader() {
        ...
        final Size pictureOptimalSize = Camera2Helper.pictureOptimalSize(this.getContext(), Camera2Helper.streamConfigurationMap(this.getCameraCharacter()).getOutputSizes(256), this.getOutputSize());
        if (pictureOptimalSize == null) {
            return null;
        }
        return ImageReader.newInstance(pictureOptimalSize.getWidth(), pictureOptimalSize.getHeight(), ImageFormat.JPEG, 1);
    }
    ...
    @Override
    public void autoFocus(final TuSdkAutoFocusCallback s) {
    ...
    private void e() {
        try {
            this.d = this.b.createCaptureRequest(CameraDevice.TEMPLATE_PREVIEW);
            this.d.addTarget(this.getPreviewSurface());
            ...
            this.b.createCaptureSession(this.d(), this.getSessionPreviewStateCallback(), this.mHandler);
        } catch (CameraAccessException var2) {
            TLog.e(var2, "startPreview Error", new Object[0]);
        }
    }
    ...
    private void a(TotalCaptureResult var1) {
        if (this.s != null && var1 != null) {
            Integer var2 = (Integer)var1.get(CaptureResult.CONTROL_AF_MODE);
            if (var2 != null && var2 != 0) {
                final Integer var3 = (Integer)var1.get(CaptureResult.CONTROL_AF_STATE);
                Integer var4 = (Integer)var1.get(CaptureResult.CONTROL_AE_STATE);
                if (var3 != null && var3 != 0) {
                    if (var3 != null && var4 != null && var3 != 0 && var4 != 0 && (this.w != var3 || this.x != var4)) {
                        this.w = var3;
                        this.x = var4;
                        boolean var5 = false;
                        switch(var4) {
                            ...
                            default:
                                if (var5) {
                                    ThreadHelper.post(new Runnable() {
                                        public void run() {
                                            SelesStillCamera2.this.observableAutofocus(var3);
                                        }
                                    });
                                }
                        }
    ...
    private void a(final CapturePhotoAsJPEGDataCallback var1) {
        if (this.b() != null && this.b != null && this.c != null) {
            this.b().setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                public void onImageAvailable(final ImageReader var1x) {
                    SelesStillCamera2.this.playSystemShutter();
                    ThreadHelper.runThread(new Runnable() {
                        public void run() {
                            SelesStillCamera2.this.onImageCaptured(var1x, var1);
                        }
                    });
                }
            }, this.mHandler);
            ...
            try {
                this.e = this.b.createCaptureRequest(CameraDevice.TEMPLATE_STILL_CAPTURE);
                this.e.addTarget(this.b().getSurface());
                ...
                TLog.e(var3, "takePictureAtAsync", new Object[0]);
                this.b(var1);
            }
