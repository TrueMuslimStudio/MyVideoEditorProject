...
public class SelesParameters
{
    ...
    public class FilterArg
    {
        ...
        public void setDefaultPercent(final float h) {
            this.h = h;
        }
        ...
        public void setMaxValueFactor(float n) {
            ...
            this.f = this.e + (int)((this.f - this.e) * n * 100.0f) / 100.0f;
    ...
    public interface FilterCosmeticInterface extends FilterFacePositionInterface
    {
        void updateCosmeticFacial(final TuSDKCosmeticImage p0);
        
        void closeCosmeticFacial();
        
        void updateCosmeticLip(final CosmeticLipFilter.CosmeticLipType p0, final int p1);
        
        void updateCosmeticLip(final CosmeticLipFilter.CosmeticLipType p0, final int[] p1);
        
        void closeCosmeticLip();
        
        void updateCosmeticBlush(final TuSDKCosmeticImage p0);
        
        void closeCosmeticBlush();
        
        void updateCosmeticEyebrow(final TuSDKCosmeticImage p0);
        
        void closeCosmeticEyebrow();
        
        void updateCosmeticEyeshadow(final TuSDKCosmeticImage p0);
        
        void closeCosmeticEyeshadow();
        
        void updateCosmeticEyeline(final TuSDKCosmeticImage p0);
        
        void closeCosmeticEyeline();
        
        void updateCosmeticEyelash(final TuSDKCosmeticImage p0);
    ...
    public interface FilterStickerInterface extends FilterFacePositionInterface
    {
        ...
        void updateDynamicStickers(final List<TuSDKDynamicStickerImage> p0);
