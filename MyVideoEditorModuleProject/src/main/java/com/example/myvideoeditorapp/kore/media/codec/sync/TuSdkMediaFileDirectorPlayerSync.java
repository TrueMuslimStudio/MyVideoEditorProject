...
import com.example.myvideoeditorapp.kore.media.codec.audio.TuSdkAudioTrackWrap;
...
import com.example.myvideoeditorapp.kore.media.codec.extend.TuSdkMediaTimeSlicePatch;
...
import com.example.myvideoeditorapp.kore.utils.TuSdkSemaphore;
...
public class TuSdkMediaFileDirectorPlayerSync implements TuSdkMediaDecodecSync
{
    ...
    public long totalVideoDurationUs() {
        ...
        return Math.abs(this.e.getOutputDurationUs() - this.i.frameIntervalUs());
    }
    ...
    public void setTimeline(final TuSdkMediaTimeline tuSdkMediaTimeline) throws IOException {
        this.pauseSave();
    ...
    private class _VideoDecodecSync extends TuSdkVideoDecodecSyncBase
    {
        ...
        @Override
        public void syncVideoDecodecInfo(final TuSdkVideoInfo tuSdkVideoInfo, final TuSdkMediaExtractor h) throws IOException {
