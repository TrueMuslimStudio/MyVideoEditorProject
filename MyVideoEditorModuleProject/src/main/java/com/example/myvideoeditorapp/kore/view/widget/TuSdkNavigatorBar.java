...
import com.example.myvideoeditorapp.kore.view.widget.button.TuSdkNavigatorBackButton;
...
public abstract class TuSdkNavigatorBar extends TuSdkRelativeLayout
{
    ...
    private void a(final int n) {
        ...
        value.setOnClickListener((OnClickListener)this.f);
    ...
    private void a(final NavigatorBarButtonType navigatorBarButtonType, final TuSdkNavigatorButton tuSdkNavigatorButton) {
        final LayoutParams layoutParams = (LayoutParams)tuSdkNavigatorButton.getLayoutParams();
    ...
    protected TuSdkSegmented buildSegmented(final int n) {
        ...
        final LayoutParams layoutParams3;
        final LayoutParams layoutParams2;
        final LayoutParams layoutParams = layoutParams2 = (layoutParams3 = new LayoutParams(-1, -1));
        ...
        final LayoutParams layoutParams5 = layoutParams;
