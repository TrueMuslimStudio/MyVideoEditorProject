                    ...
                    switch(var2) {
                        case Succeed:
                            if (var1 != null && var1.count > 0) {
                                if (var1.count == 1) {
                                    TuSDKSkinFilterAPI.this.i = TuSDKSkinFilterAPI.this.a(var1);
                                    FaceAligment var4 = new FaceAligment();
                                    var4.setOrginMarks(TuSDKSkinFilterAPI.this.i);
                                    TuSDKSkinFilterAPI.this.h.updateFaceFeatures(new FaceAligment[]{var4}, 0.0F);
