...
import com.example.myvideoeditorapp.kore.media.codec.video.TuSdkVideoSurfaceEncodecOperation;
import com.example.myvideoeditorapp.kore.seles.egl.SelesRenderer;
import com.example.myvideoeditorapp.kore.seles.egl.SelesVirtualDisplay;
...
import com.example.myvideoeditorapp.kore.seles.output.SelesSurfaceDisplay;
import com.example.myvideoeditorapp.kore.seles.output.SelesSurfacePusher;
import com.example.myvideoeditorapp.kore.seles.output.SelesSurfacePusherAsync;
...
public class TuSdkVideoSurfaceEncoder implements TuSdkEncodeSurface
{
    ...
    public int setOutputFormat(final MediaFormat mediaFormat) {
        ...
        this.p.outputFormatChanged(mediaFormat);
