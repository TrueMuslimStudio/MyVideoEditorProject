...
import com.example.myvideoeditorapp.kore.seles.egl.SelesEGLCoreSingleSurface;
...
public class TuSdkVideoImageExtractor
{
    ...
    public TuSdkVideoImageExtractor(final List<TuSdkMediaDataSource> list) {
        ...
        while (iterator.hasNext()) {
            ...
            if (tracksWithMediaType.get(0).presentSize().maxSide() >= 1920) {
                useSoftDecodec = false;
            }
        ...
        (this.e = new ImageSurfaceReceiver()).setTextureCoordinateBuilder(new SelesVerticeCoordinateCropBuilderImpl(true));
        this.c = new AVAssetTrackPipeMediaExtractor(this.b);
        (this.d = new AVAssetTrackCodecDecoder(this.c)).setUseSoftDecodec(useSoftDecodec);
    ...
    public void release() {
        this.i.runSynchronouslyOnProcessingQueue(new Runnable() {
            ...
            public void run() {
                ...
                TuSdkVideoImageExtractor.this.j = null;
            }
        });
        this.i.quit();
    }
        ...
        protected void renderToTexture(final FloatBuffer floatBuffer, final FloatBuffer floatBuffer2) {
            ...
            if (bitmap != null && TuSdkVideoImageExtractor.this.j != null) {
                ...
                ThreadHelper.post(new Runnable() {
                    @Override
                    public void run() {
                        if (TuSdkVideoImageExtractor.this.k.size() > 1 && TuSdkVideoImageExtractor.this.j != null) {
