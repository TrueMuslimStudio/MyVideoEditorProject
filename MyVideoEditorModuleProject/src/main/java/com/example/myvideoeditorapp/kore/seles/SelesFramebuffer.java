...
public class SelesFramebuffer
{
    ...
    public void copyFromFboTexture(final SelesFramebuffer selesFramebuffer) {
        GLES20.glBindFramebuffer(36160, selesFramebuffer.getFramebuffer());
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, this.getTexture());
        GLES20.glCopyTexSubImage2D(3553, 0, 0, 0, 0, 0, selesFramebuffer.g.width, selesFramebuffer.g.height);
        GLES20.glBindTexture(3553, 0);
