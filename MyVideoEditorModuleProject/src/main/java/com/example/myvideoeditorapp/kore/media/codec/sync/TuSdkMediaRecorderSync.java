...
public class TuSdkMediaRecorderSync implements TuSdkMediaEncodecSync
{
    ...
    public void syncAudioEncodecFrame(final ByteBuffer byteBuffer, final MediaCodec.BufferInfo bufferInfo) throws IOException {
        if (this.g == null) {
            return;
        }
    ...
    private class _AudioEncodecSync extends TuSdkAudioEncodecSyncBase
    {
        ...
        private void a(final TuSdkAudioEncodecOperation tuSdkAudioEncodecOperation) throws IOException {
            if (this.c < 0L) {
                return;
            }
