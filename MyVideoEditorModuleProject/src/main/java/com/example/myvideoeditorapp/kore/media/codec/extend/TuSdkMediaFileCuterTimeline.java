...
public class TuSdkMediaFileCuterTimeline extends TuSdkMediaTimeline
{
    ...
    public void fixTimeSlices(final TuSdkMediaExtractor tuSdkMediaExtractor, final boolean b, final boolean b2) throws IOException {
        this.a(tuSdkMediaExtractor, b, true);
    }
    
    public void fixTimeSlices(final TuSdkMediaExtractor tuSdkMediaExtractor, final boolean b) throws IOException {
        this.a(tuSdkMediaExtractor, b, false);
    }
    
    private void a(final TuSdkMediaExtractor tuSdkMediaExtractor, final boolean b, final boolean b2) throws IOException {
