...
package com.example.myvideoeditorapp.kore.media.codec.extend;
...
import com.example.myvideoeditorapp.kore.media.codec.audio.TuSdkAudioSupport;
import com.example.myvideoeditorapp.kore.media.codec.video.TuSdkVideoQuality;
import com.example.myvideoeditorapp.kore.media.codec.video.TuSdkVideoSupport;
...
public class TuSdkMediaFormat
{
    ...
    public static TuSdkSize getVideoKeySize(final MediaFormat mediaFormat) {
        ...
        return TuSdkSize.create(Math.max((getInteger(mediaFormat, "width", 0) + 15) / 16 * 16, getInteger(mediaFormat, "stride", 0)), Math.max(getInteger(mediaFormat, "height", 0), getInteger(mediaFormat, "slice-height", 0)));
    }
    
    public static TuSdkSize getVideoKeySize(final MediaFormat mediaFormat, final int n) {
        if (mediaFormat == null) {
            return null;
        }
        final int integer = getInteger(mediaFormat, "stride", 0);
        final int integer2 = getInteger(mediaFormat, "slice-height", 0);
        final int integer3 = getInteger(mediaFormat, "width", 0);
        final int integer4 = getInteger(mediaFormat, "height", 0);
        int n2 = integer;
        int n3 = integer2;
        int n4 = 0;
        if (n3 == 0) {
        ...
        if (integer3 * integer4 * 3 / 2 == n) {
            n2 = integer3;
            n3 = integer4;
        }
        return TuSdkSize.create(n2, n3);
    }
    ...
    public static MediaFormat buildSafeVideoEncodecFormat(final int n, final int n2, int min, int a, final int i, final int n3, final int n4) {
        ...
        if (n4 == 0 && (TuSdkDeviceInfo.getVender().equals("HUAWEI") || TuSdkDeviceInfo.getVender().equals("Xiaomi"))) {
    ...
    public static MediaFormat buildSafeAudioEncodecFormat() {
        return buildSafeAudioEncodecFormat(128000, 2);
    }
    ...
    public static MediaFormat buildSafeAudioEncodecFormat(final int n, final int n2, final int n3, final int n4) {
        return buildSafeAudioEncodecFormat(n, n2, n3, n4, true);
    }
    
    public static MediaFormat buildSafeAudioEncodecFormat(int i, int max, int max2, final int n, final boolean b) {
        ...
        if (b) {
            max2 = Math.max(128000, max2);
        }
        audioFormat.setInteger("bitrate", Math.min(Math.max(max2, audioSupport.bitrateRangeMin), audioSupport.bitrateRangeMax));
