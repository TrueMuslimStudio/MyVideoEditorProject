...
public class TuSdkAudioEncodecOperationImpl implements TuSdkAudioEncodecOperation
{
    ...
    @Override
    public int writeBuffer(final ByteBuffer byteBuffer, final MediaCodec.BufferInfo bufferInfo) throws IOException {
        final TuSdkMediaCodec a = this.a;
            ...
            try {
                ...
                do {
                    ...
                    if (dequeueInputBuffer > -1) {
                        ...
                        byteBuffer2.clear();
                        byteBuffer2.put(src);
                        bufferInfo.presentationTimeUs += this.l.intervalUs;
    ...
    @Override
    public void signalEndOfInputStream(final long presentationTimeUs) throws IOException {
        final MediaCodec.BufferInfo bufferInfo = new MediaCodec.BufferInfo();
        bufferInfo.size = 0;
    ...
    @Override
    public void autoFillMuteData(final long n, final long presentationTimeUs, final boolean b) throws IOException {
        final TuSdkMediaCodec a = this.a;
    ...
    @Override
    public void autoFillMuteDataWithinEnd(final long n, final long n2) throws IOException {
        if (this.l == null) {
            return;
        }
