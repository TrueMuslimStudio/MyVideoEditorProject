...
public class JsonHttpResponseHandler extends TextHttpResponseHandler
{
            ...
            final Runnable target = new Runnable() {
                ...
                public void run() {
                    JsonHttpResponseHandler.this.postRunnable(new Runnable() {
                        /* synthetic */ Object a = null;

                        {
                            try {
                                a = JsonHttpResponseHandler.this.parseResponse(array);
                ...
                public void run() {
                    try {
                        ...
                        JsonHttpResponseHandler.this.postRunnable(new Runnable() {
                            @Override
                            public void run() {
                                JsonHttpResponseHandler.this.onFailure(n, list, (Throwable)ex, (JSONObject)null);
                            }
                        });
                    }
                }
    ...
    protected Object parseResponse(final byte[] array) throws JSONException {
        if (null == array) {
            return null;
        }
        Object o = null;
