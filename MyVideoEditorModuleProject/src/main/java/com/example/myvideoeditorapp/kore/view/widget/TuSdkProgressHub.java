...
public abstract class TuSdkProgressHub implements TuSdkProgressHubView.TuSdkProgressHubViewDelegate
{
    ...
    private void b(final Context context) {
        ...
        (this.f = (FrameLayout)((Activity)context).getWindow().getDecorView().findViewById(16908290)).addView((View)this.c);
    }
    ...
    private void c(final Context context) {
        ...
        this.c.setDelegate(this);
        this.c.runViewShowableAnim(true);
        final WindowManager.LayoutParams buildApplicationPanelParams = TuSdkViewHelper.buildApplicationPanelParams("ProgressHub");
        try {
            this.b.addView((View)this.c, (ViewGroup.LayoutParams)buildApplicationPanelParams);
        }
        catch (Exception ex) {}
    }
