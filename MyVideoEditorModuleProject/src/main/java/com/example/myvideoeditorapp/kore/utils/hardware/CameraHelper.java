...
public class CameraHelper
{
    ...
    public static Camera.Area convertToCameraArea(final PointF pointF, ImageOrientation up, final int n) {
        ...
        return new Camera.Area(getFocusRect((int)(pointF2.x * 2000.0f) - 1000, (int)(pointF2.y * 2000.0f) - 1000, 500, 500), n);
    }
    ...
    public static List<Camera.Size> sortSizeList(List<Camera.Size> var0) {
        if (var0 != null && var0.size() != 0) {
            Collections.sort(var0, new Comparator<Camera.Size>() {
                public int compare(Camera.Size var1, Camera.Size var2) {
                    if (var1.width < var2.width) {
                        return 1;
                    } else if (var1.width > var2.width) {
                        return -1;
                    } else if (var1.height < var2.height) {
                        return 1;
                    } else {
                        return var1.height > var2.height ? -1 : 0;
                    }
                }
            });
            return var0;
    ...
    public static List<Camera.Size> sortMaxSizeList(List<Camera.Size> var0) {
        if (var0 != null && var0.size() != 0) {
            Collections.sort(var0, new Comparator<Camera.Size>() {
                public int compare(Camera.Size var1, Camera.Size var2) {
                    if (var1.width * var1.height < var2.width * var2.height) {
                        return 1;
                    } else {
                        return var1.width * var1.height > var2.width * var2.height ? -1 : 0;
                    }
                }
            });
            return var0;
    ...
    public static float getExposureCompensationStep(final Camera.Parameters parameters) {
        return parameters.getExposureCompensationStep();
    }
    
    public static int getMinExposureCompensation(final Camera.Parameters parameters) {
        return parameters.getMinExposureCompensation();
    }
    
    public static int getMaxExposureCompensation(final Camera.Parameters parameters) {
        return parameters.getMaxExposureCompensation();
    }
    
    public static int getExposureCompensation(final Camera.Parameters parameters) {
        return parameters.getExposureCompensation();
    }
    
    public static void setExposureCompensation(final int exposureCompensation, final Camera.Parameters parameters) {
        if (exposureCompensation > getMaxExposureCompensation(parameters) || exposureCompensation < getMinExposureCompensation(parameters)) {
            return;
        }
        parameters.setExposureCompensation(exposureCompensation);
    }
    
    public static float getCurrentExposureCompensationValue(final Camera.Parameters parameters) {
        return getExposureCompensationStep(parameters) * getExposureCompensation(parameters);
    }
    ...
    static {
        ...
        CameraHelper.autoFocusModes.add("fixed");
    }
}
