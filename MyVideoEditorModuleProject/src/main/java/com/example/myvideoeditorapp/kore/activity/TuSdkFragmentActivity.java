...
import com.example.myvideoeditorapp.kore.TuSpecialScreenHelper;
...
public abstract class TuSdkFragmentActivity extends FragmentActivity implements FragmentManager.OnBackStackChangedListener
{
    ...
    public void onCreate(final Bundle bundle) {
        ...
        ActivityObserver.ins.register((Activity)this);
        if (this.a == 0) {
            return;
        }
    ...
    protected void onDestroy() {
        ActivityObserver.ins.remove((Activity)this);
        super.onDestroy();
    }
    ...
    protected <T extends Fragment> void bindFragmentChangeType(FragmentTransaction var1, int var2, T var3, FragmentChangeType var4) {
        switch(var4) {
            case join:
            case push:
                var1.add(var2, var3, var3.getClass().getName());
                break;
            case tansform:
                var1.show(var3);
                break;
            case replace:
                var1.remove(this.getLastFragment());
                var1.add(var2, var3, var3.getClass().getName());
        }
    }
    ...
    public void dismissActivityWithAnim(final ActivityAnimType activityAnimType) {
        com.example.myvideoeditorapp.tv.core.activity.ActivityHelper.dismissActivityWithAnim((Activity)this, activityAnimType);
    }
    
    public void presentActivity(final TuSdkIntent tuSdkIntent, final ActivityAnimType activityAnimType, final boolean b) {
        com.example.myvideoeditorapp.tv.core.activity.ActivityHelper.presentActivity((Activity)this, tuSdkIntent, activityAnimType, b);
    }
    ...
    public void presentActivity(final Class<?> clazz, final ActivityAnimType activityAnimType, final boolean b, final boolean b2, final boolean b3) {
        com.example.myvideoeditorapp.tv.core.activity.ActivityHelper.presentActivity((Activity)this, clazz, activityAnimType, b, b2, b3);
    }
    ...
    public void presentActivity(final Class<?> clazz, final Fragment fragment, final ActivityAnimType activityAnimType, final ActivityAnimType activityAnimType2, final boolean b, final boolean b2, final boolean b3) {
        com.example.myvideoeditorapp.tv.core.activity.ActivityHelper.presentActivity((Activity)this, clazz, fragment, activityAnimType, activityAnimType2, b, b2, b3);
    }
    ...
    public void presentModalNavigationActivity(final Class<?> clazz, final Class<?> clazz2, final ActivityAnimType activityAnimType, final ActivityAnimType activityAnimType2, final boolean b) {
        this.presentModalNavigationActivity(clazz, (Fragment) ReflectUtils.classInstance(clazz2), activityAnimType, activityAnimType2, b);
    }
    ...
    public void filpModalNavigationActivity(final Class<?> clazz, final Fragment fragment, final boolean b, final boolean b2) {
        AnimHelper.rotate3dAnimtor((View)this.getRootView(), 300, 0.0f, 90.0f, 1.0f, 0.8f, (Animator.AnimatorListener)new AnimatorListenerAdapter() {
            final /* synthetic */ TuSdkIntent a = com.example.myvideoeditorapp.tv.core.activity.ActivityHelper.buildModalActivityIntent(TuSdkFragmentActivity.this, clazz, fragment, null, null, b, true);
