...
public abstract class TuSdkSearchView extends TuSdkRelativeLayout
{
    ...
    private OnFocusChangeListener c;
    ...
    public TuSdkSearchView(final Context context, final AttributeSet set, final int n) {
        ...
        this.c = (OnFocusChangeListener)new OnFocusChangeListener() {
    ...
    public void loadView() {
        ...
        (this.searchButton = this.findSearchButton()).setOnClickListener((OnClickListener)this.a);
    }
    ...
    public void viewWillDestory() {
        ...
        this.searchButton.setOnClickListener((OnClickListener)null);
        this.delegate = null;
    }
