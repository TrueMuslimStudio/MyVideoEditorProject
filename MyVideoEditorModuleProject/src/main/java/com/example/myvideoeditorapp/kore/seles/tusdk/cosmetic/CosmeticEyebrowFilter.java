...
public class CosmeticEyebrowFilter extends SelesTwoInputFilter implements SelesParameters.FilterFacePositionInterface
{
    private CosmeticEyebrowModel a;
    ...
    public CosmeticEyebrowFilter() {
        super("-scosv1", "-scosf3");
        this.d = false;
        this.e = new Object();
        this.disableSecondFrameCheck();
        this.a = new CosmeticEyebrowModel();
        this.k = 1.0f;
    }
    ...
    protected void onInitOnGLThread() {
        ...
        this.f = ByteBuffer.allocateDirect(CosmeticEyebrowModel.COSMETIC_EYEBROW_MATERIAL_POINTS_LENGTH * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        this.g = ByteBuffer.allocateDirect(CosmeticEyebrowModel.COSMETIC_EYEBROW_MATERIAL_POINTS_LENGTH * 3 / 2 * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        this.h = ByteBuffer.allocateDirect(CosmeticEyebrowModel.COSMETIC_EYEBROW_MATERIAL_POINTS_LENGTH * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        this.i = ByteBuffer.allocateDirect(CosmeticEyebrowModel.COSMETIC_EYEBROW_TRIANGLES_MAP_LENGTH * 4).order(ByteOrder.nativeOrder()).asIntBuffer();
    ...
    protected void inputFramebufferBindTexture() {
        ...
        if (this.c == null) {
            TLog.e("cosmetic eyebrow filter error: matrial is null pointer", new Object[0]);
            return;
        }
    ...
    protected SelesParameters initParams(SelesParameters initParams) {
        ...
        initParams.appendFloatArg("eyebrowAlpha", this.k);
        return initParams;
    }
    ...
    protected void submitFilterArg(final SelesParameters.FilterArg filterArg) {
        ...
        if (filterArg.equalsKey("eyebrowAlpha")) {
