...
public class CosmeticFacialFilter extends SelesTwoInputFilter implements SelesParameters.FilterFacePositionInterface
{
    private CosmeticFacialModel a;
    ...
    public CosmeticFacialFilter() {
        super("-scosv1", "-scosf5");
        this.d = false;
        this.e = new Object();
        this.disableSecondFrameCheck();
        this.a = new CosmeticFacialModel();
        this.k = 1.0f;
    }
    ...
    protected void onInitOnGLThread() {
        ...
        this.f = ByteBuffer.allocateDirect(CosmeticFacialModel.COSMETIC_FACIAL_MATERIAL_POINTS_LENGTH * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        this.g = ByteBuffer.allocateDirect(CosmeticFacialModel.COSMETIC_FACIAL_MATERIAL_POINTS_LENGTH * 3 / 2 * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        this.h = ByteBuffer.allocateDirect(CosmeticFacialModel.COSMETIC_FACIAL_MATERIAL_POINTS_LENGTH * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        this.i = ByteBuffer.allocateDirect(CosmeticFacialModel.COSMETIC_FACIAL_TRIANGLES_MAP_LENGTH * 4).order(ByteOrder.nativeOrder()).asIntBuffer();
    ...
    protected SelesParameters initParams(SelesParameters initParams) {
        ...
        initParams.appendFloatArg("facialAlpha", this.k);
        return initParams;
    }
    ...
    protected void submitFilterArg(final SelesParameters.FilterArg filterArg) {
        ...
        if (filterArg.equalsKey("facialAlpha")) {
