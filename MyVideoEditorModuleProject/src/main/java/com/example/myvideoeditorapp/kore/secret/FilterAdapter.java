...
import com.example.myvideoeditorapp.kore.network.TuSdkDownloadAdapter;
...
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.TuSDKNormalFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.arts.TuSDKArtBrushFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.base.TuSDKProgramFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.colors.TuSDKColorHDRFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.colors.TuSDKColorLomoFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.colors.TuSDKColorMixCoverFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.colors.TuSDKColorMixedFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.colors.TuSDKColorNoirFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.colors.TuSDKColorSelectiveFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.flowabs.TuSDKTfmFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.flowabs.TuSDKTfmInkFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lights.TuSDKLightGlareFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lights.TuSDKSobelEdgeFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveEdgeMagicFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveFancy01Filter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveFaultFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveHeartbeatFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveLightningFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveMegrimFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveMirrorImageFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveOldTVFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveRadialBlurFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveScanningLineFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveShakeFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveSignalFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveSloshFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveSoulOutFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.lives.TuSDKLiveXRayFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.skins.TuSDKGPUSkinGaussianBlurSmoothFilter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.skins.TuSDKSkinColor2Filter;
import com.example.myvideoeditorapp.kore.seles.tusdk.filters.skins.TuSDKSkinColorFilter;
...
import com.example.myvideoeditorapp.kore.seles.tusdk.particle.TuSDKParticleFilter;
...
public class FilterAdapter extends TuSdkDownloadAdapter<FilterThumbTaskImageWare>
{
    ...
    public List<String> verifyCodes(final List<String> list) {
        if (!this.e || list == null || this.c == null || !SdkValid.shared.isVaild()) {
            return null;
        }
    ...
    public List<FilterGroup> getGroups() {
        ...
        for (final FilterGroup filterGroup : this.a) {
            if (filterGroup.categoryId <= 0) {
                final FilterGroup copy = filterGroup.copy();
                copy.filters = new ArrayList<FilterOption>();
                final Iterator<FilterOption> iterator2 = filterGroup.filters.iterator();
                while (iterator2.hasNext()) {
                    copy.filters.add(iterator2.next().copy());
                }
                list.add(copy);
            }
        }
    ...
    public boolean appendFilterGroup(final String s, final String s2, final int groupFiltersType) {
        if (s == null) {
            TLog.e("Filter file path does not exist.", new Object[0]);
            return false;
        }
        final String loadFilterGroup = SdkValid.shared.loadFilterGroup(s, s2);
        if (loadFilterGroup == null) {
            TLog.e("[ %s ] Is an invalid filter file.", s);
            return false;
        }
        ...
        if (e.filters == null || e.filters.isEmpty()) {
            TLog.e("The filter file is invalid or already exists.", new Object[0]);
            return false;
        }
        e.groupFiltersType = groupFiltersType;
        final ArrayList filters = new ArrayList<FilterOption>(e.filters.size());
        for (final FilterOption filterOption : e.filters) {
            final FilterOption filterOption2 = e.getFilterOption(filterOption.id);
            if (filterOption2 != null) {
                if (filterOption2.version > 12) {
                    continue;
                }
                ...
                filterOption2.disableRuntime = e.disableRuntime;
        ...
        e.filters = (ArrayList<FilterOption>)filters;
        if (e.filters != null && !e.filters.isEmpty()) {
            this.a.add(e);
        }
        return true;
    ...
    public SelesOutInput createFilter(FilterOption a) {
        ...
        switch (a.filterType) {
            ...
            case 68: {
                return new TuSDKGPUSkinGaussianBlurSmoothFilter();
            }
            case 80: {
