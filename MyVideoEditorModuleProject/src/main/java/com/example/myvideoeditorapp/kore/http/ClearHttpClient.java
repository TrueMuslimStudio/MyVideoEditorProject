...
public class ClearHttpClient
{
    ...
    private HttpEntity a(final RequestParams requestParams, final ResponseHandlerInterface responseHandlerInterface) {
        ...
        try {
            ...
            if (responseHandlerInterface != null) {
                responseHandlerInterface.sendFailureMessage(0, null, null, ex);
            }
            else {
                ex.printStackTrace();
            }
    ...
    public static boolean isInputStreamGZIPCompressed(final PushbackInputStream pushbackInputStream) throws IOException {
