...
class ExifOutputStream
{
    ...
    public void writeExifData(final OutputStream out) throws IOException {
        if (this.b == null) {
            return;
        }
    ...
    private void a(final OrderedDataOutputStream orderedDataOutputStream) throws IOException {
    ...
    private void b(final OrderedDataOutputStream orderedDataOutputStream) throws IOException {
    ...
    private void a(final IfdData ifdData, final OrderedDataOutputStream orderedDataOutputStream) throws IOException {
    ...
    static void a(final ExifTag exifTag, final OrderedDataOutputStream orderedDataOutputStream) throws IOException {
