...
public class ExifInterface
{
    ...
    public void readExif(final String name, final int n) throws IOException {
        if (name == null) {
    ...
    public void readExif(final InputStream inputStream, final int n) throws IOException {
        ...
        catch (ExifInvalidFormatException | IOException obj) {
            throw new IOException("Invalid exif format : " + obj);
        }
        this.a = read;
    }
    ...
    public void writeExif(final String s) throws IOException {
    ...
    public boolean writeExif(final String name, final String s) throws IOException {
        TLog.i(" %s writeExif: %s", "ExifInterface", s);
        if (name.equals(s)) {
            return false;
        }
    ...
    public void writeExif(final InputStream inputStream, final String name) throws IOException {
    ...
    public void writeExif(final Bitmap bitmap, final String s, final int n) throws IOException {
        TLog.i(" %s writeExif: %s", "ExifInterface", s);
    ...
    private static int a(final InputStream inputStream, final OutputStream outputStream, final ExifData exifData) throws IOException {
    ...
    public void readExif(final byte[] buf, final int n) throws IOException {
