...
package com.example.myvideoeditorapp.kore.components.widget.paintdraw;
...
import com.example.myvideoeditorapp.kore.components.widget.smudge.SimpleProcessor;
...
public class PaintDrawProcessor extends SimpleProcessor
{
    ...
    public void setBrushSize(BrushSize.SizeType var1, float var2) {
        this.mBrushScale = var2;
        this.h = var1;
        switch(var1) {
            case SmallBrush:
                this.d = 1.0F * var2;
            ...
            case LargeBrush:
                ...
                break;
            case CustomizeBrush:
                this.d = var1.getCustomizeBrushValue() * 4.0F * var2;
        }
