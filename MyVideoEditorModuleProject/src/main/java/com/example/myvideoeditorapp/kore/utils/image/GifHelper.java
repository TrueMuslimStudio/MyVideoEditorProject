...
public final class GifHelper
{
    ...
    public static GifHelper openAssetFileDescriptor(final AssetFileDescriptor assetFileDescriptor) throws IOException {
        try {
    ...
    public static GifHelper openURI(final ContentResolver contentResolver, final Uri uri) throws IOException {
    ...
    public class GifIOException extends IOException
    {
        ...
        public GifIOException(GifError reason) {
            this.reason = reason;
        }
    }
