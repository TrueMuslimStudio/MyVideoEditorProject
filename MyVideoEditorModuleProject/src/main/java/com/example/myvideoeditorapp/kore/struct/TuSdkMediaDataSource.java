...
package com.example.myvideoeditorapp.kore.struct;
...
public class TuSdkMediaDataSource
{
    ...
    @SuppressLint("Range")
    private String a(final Context context, final Uri uri) {
        String string = null;
    ...
    public boolean checkIsMediaFile() {
        final MediaMetadataRetriever mediaMetadataRetriever = this.getMediaMetadataRetriever();
