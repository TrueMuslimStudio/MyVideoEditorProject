...
public class SmudgeView extends TuSdkRelativeLayout
{
    ...
    public void loadView() {
        super.loadView();
        this.addView((View)(this.c = new ImageView(this.getContext())), (ViewGroup.LayoutParams)new LayoutParams(-1, -1));
        (this.d = new ImageView(this.getContext())).setOnTouchListener(this.mOnTouchListener);
        this.addView((View)this.d, (ViewGroup.LayoutParams)new LayoutParams(-1, -1));
        (this.e = new ImageView(this.getContext())).setVisibility(4);
        this.e.setBackgroundColor(16777215);
        this.addView((View)this.e, (ViewGroup.LayoutParams)new LayoutParams(24, 24));
        this.a();
    }
    ...
    public void showOriginalImage(final boolean b) {
        if (this.getProcessorInstance() != null) {
            this.d.setVisibility(b ? View.INVISIBLE : View.VISIBLE);
        }
    }
