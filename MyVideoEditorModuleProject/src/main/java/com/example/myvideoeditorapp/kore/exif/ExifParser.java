...
class ExifParser {
    ...
    private ExifParser(InputStream var1, int var2, ExifInterface var3) throws IOException, ExifInvalidFormatException {
    ...
    private CountedDataInputStream a(InputStream var1) throws IOException, ExifInvalidFormatException {
            ...
            while(true) {
                ...
                while(true) {
                    ...
                    if (var8 != 255 && var7 == 255) {
                        ...
                        var12[0] = var10;
                        var12[1] = var9;
                        int var11 = this.a(var2, var12, 2, var6 - 2);
                        if (var11 != var6 - 2) {
    ...
    private void a(CountedDataInputStream var1) throws IOException, ExifInvalidFormatException {
    ...
    private void a(int var1, long var2) {
        this.n.put((int)var2, new IfdEvent(var1, this.a(var1)));
    }

    protected int read(byte[] var1) throws IOException {
    ...
    protected static ExifParser parse(InputStream var0, int var1, ExifInterface var2) throws IOException, ExifInvalidFormatException {
        ...
        if (null == this.o) {
            ...
            if (var1 < var2) {
                ...
                while(this.n.size() != 0) {
                    ...
                    if (var9 instanceof IfdEvent) {
                        this.r = ((IfdEvent)var9).a;
                        ...
                        if (var9 instanceof ImageEvent) {
                            this.t = (ImageEvent)var9;
                            return this.t.b;
                        }

                        ExifTagEvent var5 = (ExifTagEvent)var9;
                        this.s = var5.a;
    ...
    private void b(int var1) throws EOFException {
    ...
    protected void registerForTagValue(ExifTag var1) {
        if (var1.getOffset() >= this.o.getReadByteCount()) {
            this.n.put(var1.getOffset(), new ExifTagEvent(var1, true));
        }

    }

    private void a(long var1) {
        this.n.put((int)var1, new ImageEvent(3));
    }

    private void b(int var1, long var2) {
        this.n.put((int)var2, new ImageEvent(4, var1));
    }

    private ExifTag c() throws IOException, ExifInvalidFormatException {
            ...
            if (var2 == e && this.checkAllowed(var3, ExifInterface.TAG_EXIF_IFD)) {
                ...
                if (this.b()) {
                    if (var1.hasValue()) {
                        ...
                        this.n.put(var1.getOffset(), new ExifTagEvent(var1, false));
                    }
                }
    ...
    protected void readFullTagValue(ExifTag var1) throws IOException {
            ...
            if (var2 == 2 || var2 == 7 || var2 == 1) {
                ...
                if (this.n.size() > 0 && (Integer)this.n.firstEntry().getKey() < this.o.getReadByteCount() + var4) {
                    ...
                    if (var5 instanceof ImageEvent) {
                        ...
                        if (var5 instanceof IfdEvent) {
                            TLog.w("%s Ifd %s overlaps value for tag: %s \n", new Object[]{"ExifParser", ((IfdEvent)var5).a, var1.toString()});
                        } else if (var5 instanceof ExifTagEvent) {
                            TLog.w("%s Tag value for tag: \n%s overlaps value for tag: %s\n", new Object[]{"ExifParser", ((ExifTagEvent)var5).a.toString(), var1.toString()});
                        }
    ...
    protected int read(byte[] var1, int var2, int var3) throws IOException {
    ...
    protected String readString(int var1, Charset var2) throws IOException {
