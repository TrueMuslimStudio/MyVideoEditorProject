...
public class TuSdkLinearLayout extends LinearLayout implements TuSdkViewInterface
{
    ...
    public TuSdkLinearLayout(final Context context) {
        super(context);
        this.a = (ViewTreeObserver.OnPreDrawListener)new ViewTreeObserver.OnPreDrawListener() {
            public boolean onPreDraw() {
                TuSdkLinearLayout.this.getViewTreeObserver().removeOnPreDrawListener(TuSdkLinearLayout.this.a);
    ...
    public TuSdkLinearLayout(final Context context, final AttributeSet set) {
        super(context, set);
        this.a = (ViewTreeObserver.OnPreDrawListener)new ViewTreeObserver.OnPreDrawListener() {
            public boolean onPreDraw() {
                TuSdkLinearLayout.this.getViewTreeObserver().removeOnPreDrawListener(TuSdkLinearLayout.this.a);
    ...
    @TargetApi(11)
    public TuSdkLinearLayout(final Context context, final AttributeSet set, final int n) {
        super(context, set, n);
        this.a = (ViewTreeObserver.OnPreDrawListener)new ViewTreeObserver.OnPreDrawListener() {
            public boolean onPreDraw() {
                TuSdkLinearLayout.this.getViewTreeObserver().removeOnPreDrawListener(TuSdkLinearLayout.this.a);
