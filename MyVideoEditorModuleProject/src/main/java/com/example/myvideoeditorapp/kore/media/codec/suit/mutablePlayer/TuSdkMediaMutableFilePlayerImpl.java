...
public class TuSdkMediaMutableFilePlayerImpl implements TuSdkMediaMutableFilePlayer
{
    ...
    private boolean a() {
        ...
        requestSurfaceTexture.setOnFrameAvailableListener((SurfaceTexture.OnFrameAvailableListener)new SurfaceTexture.OnFrameAvailableListener() {
            public void onFrameAvailable(final SurfaceTexture surfaceTexture) {
                if (TuSdkMediaMutableFilePlayerImpl.this.i != null) {
    ...
    public void setSpeed(final float var1) {
        this.e.b(new Runnable() {
            public void run() {
                if (TuSdkMediaMutableFilePlayerImpl.this.speed() != var1) {
                    TuSdkMediaMutableFilePlayerImpl.this.q.setSpeed(var1);
                    if (TuSdkMediaMutableFilePlayerImpl.this.d != null) {
                        TuSdkMediaMutableFilePlayerImpl.this.d.a(var1);
                    }
    ...
    public boolean supportSeek() {
        return this.l != null && this.l.supportSeek();
    }
    ...
    @TargetApi(14)
    private boolean g() {
        (this.g = new SelesSurfaceReceiver()).setTextureCoordinateBuilder(new SelesVerticeCoordinateCropBuilderImpl(true));
    ...
    private class VideoRender extends InternalRender implements AVAssetTrackSampleBufferOutput.AVAssetTrackSampleBufferInput
    {
        ...
        public void outputFormatChaned(final MediaFormat corp, final AVAssetTrack avAssetTrack) {
            ...
            TuSdkMediaMutableFilePlayerImpl.this.g.setInputSize(TuSdkMediaMutableFilePlayerImpl.this.p.codecSize.transforOrientation(avAssetTrack.orientation()));
            TuSdkMediaMutableFilePlayerImpl.this.g.setPreCropRect(TuSdkMediaMutableFilePlayerImpl.this.p.codecCrop);
            TuSdkMediaMutableFilePlayerImpl.this.g.setInputRotation(ImageOrientation.Up);
        }
