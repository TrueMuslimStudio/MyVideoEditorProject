...
import com.example.myvideoeditorapp.kore.utils.anim.AccelerateDecelerateInterpolator;
...
public class TuSdkListViewFlingAction
{
    ...
    private void b(final MotionEvent motionEvent) {
        ...
        if (b) {
            this.h.flingStateWillChange(true);
            ViewCompat.animate((View)this.h.flingCellWrap()).translationX((float)(-this.h.flingWrapWidth())).setDuration(this.d).setInterpolator((Interpolator)new AccelerateDecelerateInterpolator());
        }
        else {
            this.resetDownView();
        }
    ...
    public void resetDownView() {
        ...
        ViewCompat.animate((View)this.h.flingCellWrap()).translationX(0.0f).setDuration(this.d).setInterpolator((Interpolator)new AccelerateDecelerateInterpolator());
    }
