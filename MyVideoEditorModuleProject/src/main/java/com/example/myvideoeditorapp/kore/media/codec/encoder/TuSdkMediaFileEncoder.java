...
public class TuSdkMediaFileEncoder
{
    ...
    public void signalAudioEndOfInputStream(final long n) throws IOException {
        if (this.g == null) {
            return;
        }
    ...
    public void autoFillAudioMuteData(final long n, final long n2, final boolean b) throws IOException {
        if (this.g == null) {
            return;
        }
