...
package com.example.myvideoeditorapp.kore.seles.filters;
...
public class SelesFilter extends SelesOutInput
{
    ...
    protected void renderToTexture(final FloatBuffer floatBuffer, final FloatBuffer floatBuffer2) {
        ...
        while (!GLES20.glIsTexture(this.mOutputFramebuffer.getTexture())) {
            sharedFramebufferCache.recycleFramebuffer(this.mOutputFramebuffer);
            this.mOutputFramebuffer = sharedFramebufferCache.fetchFramebuffer(SelesFramebuffer.SelesFramebufferMode.FBO_AND_TEXTURE, sizeOfFBO, this.getOutputTextureOptions());
        }
        if (!GLES20.glIsTexture(this.mOutputFramebuffer.getTexture())) {
            TLog.i("fetchFramebuffer again glIsTexture return false", new Object[0]);
        }
