...
package com.example.myvideoeditorapp.kore.seles.filters.image;
...
import com.example.myvideoeditorapp.kore.seles.filters.SelesTwoPassFilter;
...
public class SelesGaussianBlurFilter extends SelesTwoPassTextureSamplingFilter
{
    ...
    public void switchTo(final String var1, final String var2) {
        this.runOnDraw(new Runnable() {
            public void run() {
                SelesGaussianBlurFilter.this.mFilterProgram = SelesContext.program(var1, var2);
                if (!SelesGaussianBlurFilter.this.mFilterProgram.isInitialized()) {
                    ...
                    if (!SelesGaussianBlurFilter.this.mFilterProgram.link()) {
                        TLog.i("Program link log: %s", new Object[]{SelesGaussianBlurFilter.this.mFilterProgram.getProgramLog()});
                        TLog.i("Fragment shader compile log: %s", new Object[]{SelesGaussianBlurFilter.this.mFilterProgram.getFragmentShaderLog()});
                        TLog.i("Vertex link log: %s", new Object[]{SelesGaussianBlurFilter.this.mFilterProgram.getVertexShaderLog()});
                ...
                SelesGaussianBlurFilter.this.mSecondFilterProgram = SelesContext.program(var1, var2);
                if (!SelesGaussianBlurFilter.this.mSecondFilterProgram.isInitialized()) {
                    ...
                    if (!SelesGaussianBlurFilter.this.mSecondFilterProgram.link()) {
                        TLog.i("Program link log: %s", new Object[]{SelesGaussianBlurFilter.this.mSecondFilterProgram.getProgramLog()});
                        TLog.i("Fragment shader compile log: %s", new Object[]{SelesGaussianBlurFilter.this.mSecondFilterProgram.getFragmentShaderLog()});
                        TLog.i("Vertex link log: %s", new Object[]{SelesGaussianBlurFilter.this.mSecondFilterProgram.getVertexShaderLog()});
