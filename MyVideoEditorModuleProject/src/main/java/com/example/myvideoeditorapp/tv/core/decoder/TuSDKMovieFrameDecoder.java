...
import com.example.myvideoeditorapp.tv.core.delegate.TuSDKAudioPacketDelegate;
import com.example.myvideoeditorapp.tv.core.delegate.TuSDKVideoFrameDecodeDelegate;
        ...
        if (!this.e) {
            ...
            if (this.mMovieReader != null) {
                ...
                if (this.f && this.findAudioTrack() != -1 && this.j != null) {
                    MediaFormat var1 = this.getAudioTrackFormat();
                    this.j.onAudioInfoReady(var1);
                }

                this.mVideoDecoder = this.createVideoDecoder((Surface)null);
