...
import com.example.myvideoeditorapp.tv.core.encoder.video.TuSDKHardVideoDataEncoderInterface;
...
@TargetApi(18)
public abstract class SelesSyncSurfaceTextureEncoder implements SelesSurfaceEncoderInterface {
    ...
    public void setDelegate(TuSDKVideoDataEncoderDelegate var1) {
        this.u = var1;
    }
