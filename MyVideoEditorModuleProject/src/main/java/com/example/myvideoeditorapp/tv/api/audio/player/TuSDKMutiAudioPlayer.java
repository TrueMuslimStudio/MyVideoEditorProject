package com.example.myvideoeditorapp.tv.api.audio.player;

import android.media.AudioTrack;
import android.util.Log;

import com.example.myvideoeditorapp.tv.api.audio.preproc.mixer.TuSDKAudioEntry;
import com.example.myvideoeditorapp.tv.api.audio.preproc.mixer.TuSDKAudioMixer;
import com.example.myvideoeditorapp.tv.api.audio.preproc.mixer.TuSDKAverageAudioMixer;
import com.example.myvideoeditorapp.tv.core.decoder.TuSDKAudioDecoderTaskManagaer;
import com.example.myvideoeditorapp.tv.core.decoder.TuSDKAudioInfo;
...
public class TuSDKMutiAudioPlayer {
    String TAG = "TuSDKMutiAudioPlayer";
    ...
    public void asyncPrepare(final List<TuSDKAudioEntry> c) {
        ...
        if (this.a == null || this.a.size() == 0) {
            Log.e(TAG, "%s : Please set a valid file path" + new Object[]{this});
            return;
        }
