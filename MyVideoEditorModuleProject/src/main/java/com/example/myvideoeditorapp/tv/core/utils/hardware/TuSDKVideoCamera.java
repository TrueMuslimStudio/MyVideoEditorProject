...
import com.example.myvideoeditorapp.kore.seles.filters.SelesFrameDelayFilter;
...
import com.example.myvideoeditorapp.kore.seles.sources.SelesVideoCamera;
...
import com.example.myvideoeditorapp.kore.utils.hardware.TuSdkVideoCameraExtendViewInterface;
...
import com.example.myvideoeditorapp.tv.core.audio.TuSDKAudioCaptureSetting;
import com.example.myvideoeditorapp.tv.core.audio.TuSDKAudioRecorderCore;
...
import com.example.myvideoeditorapp.tv.core.encoder.audio.TuSDKAudioEncoderSetting;
import com.example.myvideoeditorapp.tv.core.encoder.video.TuSDKHardVideoDataEncoder;
import com.example.myvideoeditorapp.tv.core.encoder.video.TuSDKSoftVideoDataEncoder;
...
import com.example.myvideoeditorapp.tv.core.seles.video.SelesSurfaceTextureEncoder;
...
public abstract class TuSDKVideoCamera extends SelesVideoCamera implements SelesVideoCameraInterface
{
    ...
    public final void captureImage() {
        ...
        SelesFilter selesFilter;
        if (this.mFilterWrap.getLastFilter() instanceof SelesFilterGroup) {
            selesFilter = (SelesFilter)((SelesFilterGroup)this.mFilterWrap.getLastFilter()).getTerminalFilter();
        }
        else {
            selesFilter = (SelesFilter)this.mFilterWrap.getLastFilter();
        }
        if (selesFilter == null) {
            return;
        }
        this.runOnDraw((Runnable)new Runnable() {
            ...
            public void run() {
                ...
                selesFilter.setFrameProcessingDelegate(TuSDKVideoCamera.this.X);
            }
        });
    }
