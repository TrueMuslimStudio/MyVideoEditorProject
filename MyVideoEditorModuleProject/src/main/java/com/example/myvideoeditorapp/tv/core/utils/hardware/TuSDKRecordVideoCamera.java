...
import com.example.myvideoeditorapp.tv.api.movie.postproc.muxer.TuSDKMovieClipper;
...
import com.example.myvideoeditorapp.tv.core.seles.sources.TuSDKMovieCreatorInterface;
...
public class TuSDKRecordVideoCamera extends TuSDKVideoCamera implements TuSDKMovieCreatorInterface
{
    ...
    public TuSDKRecordVideoCamera(final Context context, final TuSDKVideoCaptureSetting tuSDKVideoCaptureSetting, final RelativeLayout relativeLayout) {
        ...
        this.a = new TuSDKMovieClipper.TuSDKMovieClipperListener() {
            ...
            @Override
            public void onDone(final String pathname) throws IOException {
    ...
    private void g() {
        if (this.mMuxer == null && this.getMovieOutputPath() != null) {
            try {
                (this.mMuxer = new MediaMuxer(this.getMovieOutputPath().toString(), MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4)).setOrientationHint(this.getDeviceOrient().getDegree());
            }
    ...
    protected void notifyRecordingResultWithVideoFile(final File videoPath) throws IOException {
    ...
    public void _stopRecording() throws IOException {
    ...
    @SuppressLint({ "InlinedApi" })
    private void a(final ByteDataFrame byteDataFrame) throws IOException {
    ...
    private void b(final ByteDataFrame byteDataFrame) throws IOException {
        ...
        tuSDKFrameSpeedRateController.setFrameSpeedRateCallback(new TuSDKFrameSpeedRateController.FrameSpeedRateCallback() {
            @Override
            public void onAvailableFrameTimeUs(final long n) throws IOException {
