...
import com.example.myvideoeditorapp.kore.media.codec.audio.TuSdkAudioRecord;
...
import com.example.myvideoeditorapp.kore.media.codec.audio.TuSdkMicRecord;
import com.example.myvideoeditorapp.kore.media.codec.encoder.TuSdkAudioEncoder;
import com.example.myvideoeditorapp.kore.media.codec.encoder.TuSdkEncoderListener;
import com.example.myvideoeditorapp.kore.media.codec.encoder.TuSdkMediaFileMuxer;
...
import com.example.myvideoeditorapp.tv.api.audio.preproc.processor.TuSdkAudioEngine;
...
public class TuSdkAudioRecorder
{
    ...
    public TuSdkAudioRecorder(final TuSdkAudioRecorderSetting a, final TuSdkAudioRecorderListener y) {
        ...
        this.z = (TuSdkAudioRecord.TuSdkAudioRecordListener)new TuSdkAudioRecord.TuSdkAudioRecordListener() {
            public void onAudioRecordOutputBuffer(final ByteBuffer byteBuffer, final MediaCodec.BufferInfo bufferInfo) throws IOException {
        ...
        this.C = new TuSdkAudioEngine.TuSdKAudioEngineOutputBufferDelegate() {
            @Override
            public void onProcess(final ByteBuffer byteBuffer, final MediaCodec.BufferInfo bufferInfo) throws IOException {
    ...
    private MediaFormat b() {
        return TuSdkMediaFormat.buildSafeAudioEncodecFormat(44100, 1, 128000, 2);
    }
