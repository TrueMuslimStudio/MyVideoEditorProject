...
public class TuSDKHardVideoDataEncoder implements TuSDKHardVideoDataEncoderInterface
{
    ...
    private MediaCodec a(final String s) throws IOException {
    ...
    public boolean initCodec(final TuSDKVideoEncoderSetting e) {
        ...
        try {
            (this.c = this.a("video/avc")).configure(this.a(this.getVideoEncoderSetting()), (Surface)null, (MediaCrypto)null, MediaCodec.CONFIGURE_FLAG_ENCODE);
