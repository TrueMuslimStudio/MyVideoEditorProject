...
public class TuSdkMixerRender implements TuSdkAudioRender
{
    ...
    public boolean onAudioSliceRender(final ByteBuffer byteBuffer, final MediaCodec.BufferInfo bufferInfo, final TuSdkAudioRenderCallback tuSdkAudioRenderCallback) throws IOException {
        if (!this.g) {
            return false;
        }
