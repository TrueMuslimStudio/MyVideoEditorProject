...
package com.example.myvideoeditorapp.tv.api.movie.postproc.muxer;
...
public class TuSDKMovieClipper
{
    ...
    public List<TuSDKMovieSegment> getSegmentList(long var1, List<TuSDKMovieSegment> var3) {
        Object var4 = new ArrayList();
        TuSDKMovieSegment var5 = this.getTotalSegment(var1);
        ((List)var4).add(var5);

        TuSDKMovieSegment var7;
        for(Iterator var6 = var3.iterator(); var6.hasNext(); var4 = this.getNewList(var7, var5, (List)var4)) {
            var7 = (TuSDKMovieSegment)var6.next();
        }

        if (var4 != null && ((List)var4).size() != 0) {
            Collections.sort((List)var4, new Comparator<TuSDKMovieSegment>() {
                public int compare(TuSDKMovieSegment var1, TuSDKMovieSegment var2) {
                    long var3 = var1.startTime;
                    long var5 = var2.startTime;
    ...
    public List<TuSDKMovieSegment> getNewList(final TuSDKMovieSegment tuSDKMovieSegment, final TuSDKMovieSegment tuSDKMovieSegment2, final List<TuSDKMovieSegment> list) {
        ...
        list2.addAll((Collection<? extends TuSDKMovieSegment>) list);
    ...
    private void a(final Uri uri, final String s, final long n, final long n2) {
        ...
        this.b.seekTo(n, MediaExtractor.SEEK_TO_CLOSEST_SYNC);
    ...
    private long b(final Uri uri, final String prefix, final long n, final long n2) {
        ...
        extractor.seekTo(n, MediaExtractor.SEEK_TO_CLOSEST_SYNC);
    ...
    public interface TuSDKMovieClipperListener
    {
        ...
        void onDone(final String p0) throws IOException;
