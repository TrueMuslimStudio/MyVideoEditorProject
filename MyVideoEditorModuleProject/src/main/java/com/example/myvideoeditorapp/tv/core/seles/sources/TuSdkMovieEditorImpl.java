...
public class TuSdkMovieEditorImpl implements TuSdkMovieEditor
{
    ...
    public TuSdkMovieEditorImpl(final Context a, final ViewGroup b, final TuSdkMovieEditorOptions j) {
        this.l = new TuSdkEditorTranscoder.TuSdkTranscoderProgressListener() {
            ...
            @Override
            public void onLoadComplete(final TuSDKVideoInfo tuSDKVideoInfo, final TuSdkMediaDataSource tuSdkMediaDataSource) throws IOException {
    ...
    private void a(final TuSDKVideoInfo tuSDKVideoInfo, final TuSdkMediaDataSource dataSource) throws IOException {
        this.i = dataSource;
