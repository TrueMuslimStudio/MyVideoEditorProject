...
import com.example.myvideoeditorapp.tv.api.transcoder.TuSDKMovieTranscoder;
...
import com.example.myvideoeditorapp.tv.core.delegate.TuSDKVideoLoadDelegate;
            ...
            if (this.mMovieReader != null) {
                ...
                if (this.mVideoDecoder != null) {
                    if (this.f == null) {
                        ...
                        if (this.n) {
                            TuSDKVideoInfo var1 = this.getOriginalVideoInfo();
                            this.f.bitrate = var1.bitrate;
                            this.f.existAudioTrack = var1.existAudioTrack;
                        }
                    ...
                    } else if (this.f != null && this.f.width > 0) {
