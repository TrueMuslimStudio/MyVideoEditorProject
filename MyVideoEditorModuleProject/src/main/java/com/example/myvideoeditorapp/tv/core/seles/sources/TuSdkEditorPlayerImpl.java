...
import com.example.myvideoeditorapp.kore.seles.extend.SelesVerticeCoordinateFillModeBuilder;
...
import com.example.myvideoeditorapp.tv.video.editor.TuSdkMediaRepeatTimeEffect;
import com.example.myvideoeditorapp.tv.video.editor.TuSdkMediaReversalTimeEffect;
import com.example.myvideoeditorapp.tv.video.editor.TuSdkMediaSlowTimeEffect;
...
public class TuSdkEditorPlayerImpl implements TuSdkEditorPlayer
{
    ...
    protected boolean loadVideo() throws IOException {
    ...
    @Override
    public void setTimeEffect(final TuSdkMediaTimeEffect o) throws IOException {
        if (this.a == null) {
            return;
        }
        if (o == null) {
    ...
    @Override
    public void clearTimeEffect() throws IOException {
        if (this.a == null) {
            return;
        }
        if (this.i == null) {
